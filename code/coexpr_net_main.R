...
# ------------------------------------------------------------------------------
# coexpr_virus_host_analyzer 
# ------------------------------------------------------------------------------
#  
# This function creates and analyze the protein-protein interaction network for 
# cellsinfected by a virus. Analysis includes basic network properties and
# community detection with functional annotation. 
#
# Inputs:
# * virus: one of "VACV", "EBV", "HSV1"
# * corr_method: one of "pearson", "proportionality", "gaussian", "pcor"
...
#
#-------------------------------------------------------------------------------
# coexpr_virus_host_analyzer <- function(virus, corr_method="pearson", 
#                                    FDR_threshold=0.05,
#                                    LogFC_threshold=1, enrichment_threshold=0.01, 
#                                    adj_pval_corr_threshold=0.01, lambda=2,
#                                    cutoff_filter = "modularity", nlinks = 3){
  ...
  filename <- paste("topGo_final_results_communities_",virus,"_",
                    corr_method,".csv", sep="")
